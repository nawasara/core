@props(['disabled' => false, 'autofocus' => false, 'useGenPassword' => false, 'usePasswordField' => false])
        ...
        <div class="space-y-3 hs-accordion" id="nawasara-generate-password-form">
            ...
            <div id="nawasara-generate-password-button"
                ...
                <div class="w-full p-5 mx-auto text-gray-800 border rounded-lg" x-data="app()"
                    ...
                    <div class="mb-2">
                        <x-nawasara-core::form.input label="Password Length" ype="number" min="1"
                        ...
                        <input type="range"
                            ...
                            id="steps-range-slider-usage" aria-orientation="horizontal" min="1" max="18"
                            step="1" x-model="charsLength" @input="generatePassword()">
                    </div>
