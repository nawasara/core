<div>
    <x-nawasara-ui::page.card class="mb-5">
        <x-nawasara-ui::form.input id="role_name" name="role_name" label="Role Name" placeholder="Enter role name"
            ...
            <x-nawasara-ui::page.card>
                ...
                <div class="grid grid-cols-2 gap-4 mt-2">
                    @foreach ($groups as $group => $permissions)
                        <x-nawasara-ui::page.card x-data="{
                            ...
                            <x-nawasara-ui::form.checkbox name="check_all_{{ Str::slug($group) }}"
                            ...
                            <ul class="flex flex-wrap gap-2">
                                @foreach ($permissions as $permission)
                                    <li
                                        ...
                                        <x-nawasara-ui::form.checkbox name="permissions[]"
                                            value="{{ $permission['id'] }}"
    ...
    <div class="flex justify-end mt-5">
        ...
        <x-nawasara-ui::button color="success" x-data="{ disabled: false }" x-bind:disabled="disabled"
