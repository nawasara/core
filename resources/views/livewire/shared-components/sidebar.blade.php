                ...
                <ul class="space-y-3">
                    @foreach (app('nawasara.menu') as $menu)
                        @if (!empty($menu['submenu']))
                            ...
                            <li>
                                <div
                                    class="mb-1 text-xs font-bold text-gray-850 uppercase tracking-wider dark:text-white">
                                    {{ $menu['label'] }}
                                </div>
